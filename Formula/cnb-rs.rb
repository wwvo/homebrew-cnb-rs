class CnbRs < Formula
  ...
  on_linux do
    on_arm do
      url "https://github.com/wwvo/cnb-cli-rs/releases/download/v0.5.0/cnb-rs-v0.5.0-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "7d30ae8e76d55caf0d52e9574c6b0805909a9f9f52a4c9fc9c4d35c1d408879a"
    end
    on_intel do
      url "https://github.com/wwvo/cnb-cli-rs/releases/download/v0.5.0/cnb-rs-v0.5.0-x86_64-unknown-linux-gnu.tar.gz"
